...
describe('POST /futureproductionoffers/:id/approve', () => {
    let application;
    ...
    it('Should return unauthorized without token', function() {
        return request(application)
            .post('/api/futureproductionoffers/00000000000000aabb000001/approve')
    ...
    it('Should return future production not found', function() {
        return request(application)
            .post('/api/futureproductionoffers/00000000000000aabb000005/approve')
            .set('Accept', 'application/json')
    ...
    it('Should return future production is not pending', function() {
        return request(application)
            .post('/api/futureproductionoffers/00000000000000aabb000002/approve')
            .set('Accept', 'application/json')
            .set('Authorization', `Bearer ${TOKEN_ADMIN}`)
            .expect(400)
            .then((response) => {
    ...
    it('Should change state future production to active', function() {
        ...
        return request(application)
            ...
            .then((futureProduction) => {
                futureProduction.status.should.be.equal('active');
